...
def hit_chance_PvE():
    ...
    while True:
        ...
        if player_chance_to_miss > 0:
            ...
            print(f'{player_name} hits {bot_name}  by {player_chance_to_miss} points!')
        ...
        if bot_chance_to_miss > 0:
            ...
            print(f'{bot_name} hits {player_name}  by {bot_chance_to_miss} points!')
            print(f'{player_name} has {player_hp} hp.')
        else:
